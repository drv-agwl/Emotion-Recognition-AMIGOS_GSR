...
def trainTask(task,outfile):
	...
	"======35 fold validation======"
	'''
	folder = 'gsr_result/gsr_fusion/svm/img/pca/'+outfile[:-4]+'/'
	...
	writefile('gsr_result/gsr_fusion/rfe/'+outfile,a_accuracy,'arousal','w')
	writefile('gsr_result/gsr_fusion/rfe/'+outfile,v_accuracy,'valence','a')
	writefeat('gsr_result/gsr_fusion/rfe/ft/'+outfile,a_best_feature,vote_a,'arousal','w')
	writefeat('gsr_result/gsr_fusion/rfe/ft/'+outfile,v_best_feature,vote_v,'valence','a')
