...
def main():
	...
	trainTask([0,2694],'fusion_svmLN.csv')
...
def trainTask(task,outfile):
	...
	writefile('gsr_result/gsr_fusion/svm/'+outfile,a_accuracy,'arousal','w')
	writefile('gsr_result/gsr_fusion/svm/'+outfile,v_accuracy,'valence','a')
